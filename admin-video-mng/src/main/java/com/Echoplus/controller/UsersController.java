...
import com.Echoplus.bean.AdminUser;
import com.Echoplus.pojo.Users;
import com.Echoplus.service.UsersService;
...
public class UsersController {
	...
	@PostMapping("login")
	@ResponseBody
	public EchoplusJSONResult userLogin(String username, String password,
			HttpServletRequest request, HttpServletResponse response) {
		
		// TODO 模拟登陆
		if (StringUtils.isBlank(username) || StringUtils.isBlank(password)) {
			return EchoplusJSONResult.errorMap("用户名和密码不能为空");
		...
		return EchoplusJSONResult.errorMsg("登陆失败，请重试...");
	}
